      ...
      data: {
        ...
        permissions: {
          create: [
            ...
            'reports.view', 'settings.manage', 'inventory.manage', 'audit.view',
            'corporate.manage', 'campaigns.manage', 'offers.manage', 'categories.manage',
            'accounting.view', 'invoices.manage', 'payments.manage', 'refunds.manage',
            'tickets.manage', 'role_permissions.manage',
          ].map((p) => ({ permission: p })),
        },
      },
    });
    console.log('✅ Created default admin user (admin@3boxesluxury.com / Admin@123)');
  }
