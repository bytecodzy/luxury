  ...
  return (
    <section id="app-download" className="relative overflow-hidden border-t border-amber-900/30 bg-gradient-to-b from-stone-950 via-stone-900/50 to-stone-950 py-16 sm:py-20 lg:py-24">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/4 top-1/4 h-64 w-64 rounded-full luxury-glow-bg blur-3xl" style={{ opacity: 0.3 }} />
        <div className="absolute bottom-1/4 right-1/4 h-48 w-48 rounded-full luxury-glow-bg blur-3xl" style={{ opacity: 0.25 }} />
        <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full luxury-glow-bg blur-3xl" style={{ opacity: 0.15 }} />
      </div>
      ...
      <div className="relative container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-amber-500/25 bg-amber-500/[0.08] px-4 py-1.5 text-xs font-medium luxury-accent-text">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-amber-200/55 sm:text-lg">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            >
              {/* Phone frame with infographic image */}
              <div className="relative mx-auto w-64 sm:w-72">
                <div className="overflow-hidden rounded-[2.5rem] border-2 border-amber-500/25 bg-stone-900 p-2 shadow-2xl shadow-black/30">
                  <div className="overflow-hidden rounded-[2rem] bg-stone-950">
                    {/* Try the infographic image first, fall back to mockup */}
                    <div className="relative aspect-[9/16] bg-gradient-to-br from-stone-900 to-stone-950">
                      <Image
                        src="/images/infographics/mobile-app-premium.png"
                        alt="3 Boxes Luxury Mobile App"
                        fill
                      ...
                      />
                      {/* Fallback mockup content (shown when image fails) */}
                      <div className="absolute inset-0 flex flex-col items-center px-4 py-6">
                        {/* Status bar */}
                        <div className="flex items-center justify-between w-full bg-stone-900 px-6 py-1.5 mb-4 rounded-t-xl">
                ...
                {/* Glow effect */}
                <div className="absolute -inset-4 -z-10 rounded-[3rem] luxury-glow-bg blur-xl" style={{ opacity: 0.5 }} />
              </div>
              ...
              <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row">
                ...
                {canInstall ? (
                  <motion.button
                    ...
                    className="flex items-center gap-3 rounded-xl border border-amber-500/25 bg-amber-600/15 px-6 py-3.5 shadow-lg shadow-black/20 transition-colors hover:border-amber-500/40 hover:bg-amber-600/25"
                  >
                    <Download className="h-6 w-6 luxury-accent-text" />
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={handleInstallClick}
                    className="flex items-center gap-3 rounded-xl border border-amber-500/15 bg-stone-900 px-5 py-3 shadow-lg shadow-black/10 transition-colors hover:border-amber-500/30 hover:bg-stone-800"
                  >
              ...
              <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row">
                ...
                >
                  <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none">
                    <path d="M14.5 3.5L3 15l6 6 2-2 3.5-3.5L19 10l-4.5-6.5z" fill="#42A5F5" />
                    <path d="M14.5 3.5L8 10l3.5 3.5L19 10l-4.5-6.5z" fill="#0277BD" />
                    <path d="M8 10L3 15l6 6 2-2-3-9z" fill="#01579B" />
                  </svg>
                  <div className="text-left">
                    <div className="text-[10px] leading-tight text-amber-200/50">FLUTTER APP</div>
                    <div className="text-sm font-semibold text-amber-100">Download APK</div>
                  </div>
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.03 }}
                  ...
                  className="flex items-center gap-3 rounded-xl border border-amber-500/15 bg-stone-900 px-5 py-3 shadow-lg shadow-black/10 transition-colors hover:border-amber-500/30 hover:bg-stone-800"
                >
                  <Smartphone className="h-7 w-7 luxury-accent-text opacity-70" />
                  <div className="text-left">
                    <div className="text-[10px] leading-tight text-amber-200/50">WEB APP</div>
                    <div className="text-sm font-semibold text-amber-100">Flutter Web</div>
                  </div>
                </motion.button>
              </div>

              <p className="mt-4 text-xs text-amber-200/35">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {benefits.map((benefit, i) => (
                  <motion.div
                    ...
                    className="group rounded-xl border border-amber-500/10 bg-amber-500/[0.03] p-4 backdrop-blur-sm transition-colors hover:border-amber-500/25 hover:bg-amber-500/[0.06]"
                  >
                    <div className="mb-2 flex items-center gap-2">
                      <div className="flex h-8 w-8 items-center justify-center rounded-lg luxury-glow-bg transition-colors group-hover:bg-amber-500/15">
                        <benefit.icon className="h-4 w-4 luxury-accent-text" />
                      </div>
              ...
              >
                ...
                <span className="flex items-center gap-1 text-xs text-amber-200/35">
